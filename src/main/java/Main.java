...
public class Main {
        public static void main(String[] args) {
                ...
                List<HotDrinks> hotDrinksList = new ArrayList<>(List.of(hotDrinks1, hotDrinks2, hotDrinks3, hotDrinks4,
                                hotDrinks5, hotDrinks6, hotDrinks7, hotDrinks8, hotDrinks9));

                Drinks.initProduct(hotDrinksList);

                System.out.println(
                                "Поиск по названию: " + Drinks.getProduct("шоколад").replace("[", "").replace("]", ""));
                ...
                view.createGroup(new Group(new ArrayList<>(List.of(hotDrinks1,
                                hotDrinks2,
                                hotDrinks3,
                                hotDrinks4)),
                                new Authomat("Автомат", "Горячие_напитки", "кофейня"), 10));

                view.createGroup(new Group(new ArrayList<>(List.of(hotDrinks5,
                                hotDrinks6,
                                hotDrinks7,
                                hotDrinks8,
                                hotDrinks9)),
